...
const Stories = () => {
    ...
    return (
        <div className=' lg:px-28 mb-28  px-5 '>
            <h2 className=' text-center mt-20 mb-32 text-4xl font-bold text-neutral'>Stories of Successful Students</h2>
            <div className=' grid lg:grid-cols-3 grid-cols-1 gap-16 lg:gap-8'>
                {
                    data.map(d => <div key={d.id} className=' bg-slate-200 '>
                        ...
                        <div className=' px-10 py-5'>
                            ...
                            <div>
                                <h4 className=' text-neutral font-bold text-lg'>{d.name}</h4>
                                <p>{d.position}</p>
                            </div>
                        </div>
                    </div>)
